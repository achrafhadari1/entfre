...
export default function Home() {
  return (
    <>
      <Recentlyadded />
      <Horizontalsection />
      <div className="h-screen flex items-center justify-center w-full casta ">
        <div className="flex justify-between h-screen">
          ...
          <div className=" text-right flex flex-col justify-between pb-6 pl-6 pr-6 w-[50%]">
            <div>
              <h3 className=" mt-4 text-[#E00] text-4xl md:font-display leading-none lg:tracking-tight lg:text-6xl lg:leading-none font-bold">
                FRANK OCEAN: The Artist is Absent
              </h3>
            </div>

            <div className="text-right font-medium block tracking-normal font-medium text-sm md:text-lg max-w-2xl md:leading-tight ml-auto mt-4 md:mt-8">
              <a href="#" className="mb-12 style-2">
                Read More
              </a>
              <div className="text-[#E00] text-[1.5rem] mb-auto">
                ...
                heart of Blonde in “The Artist is Absent,” a feature accompanied
                by a photo editorial shot by Petra Collins and styled by Mel
                Ottenberg. The print edition is still available at our online
                store.
              </div>
              <div className=" pl-16 text-[1.3rem]">By ACHRAF HADARI</div>
            </div>
          </div>
        </div>
      </div>
